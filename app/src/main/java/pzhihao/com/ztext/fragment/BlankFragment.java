package pzhihao.com.ztext.fragment;
...
import pzhihao.com.ztext.R;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link BlankFragment.OnBlankFragmentInteractionListener} interface
...
public class BlankFragment extends SupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       TextView textView= (TextView) view.findViewById(R.id.f1_tv);
        textView.setText(mParam1+"/"+mParam2);
        Button button= (Button) view.findViewById(R.id.btn);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startWithPop(BlankFragment.newInstance("新的","fragment"));
            }
        });
